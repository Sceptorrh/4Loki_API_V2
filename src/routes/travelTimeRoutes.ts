...
import { travelTimeSchema } from '../schemas/travelTimeSchema';
 ...
 *         description: Server error
 */
router.post('/', validate(travelTimeSchema), handler.create.bind(handler));
 ...
 *         description: Server error
 */
router.put('/:id', validate(travelTimeSchema), handler.update.bind(handler));
